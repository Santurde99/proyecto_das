...
public class Repeatable_Upgrade extends Generic_Upgrade{
    ...
    public Repeatable_Upgrade(int id, String name, String desc, int kind, int upgrade_target, int status, int img, int price, int upgrade_value, int[] unlocks) {
        super(id, name, desc, kind, upgrade_target, status, img, price, upgrade_value, unlocks);
    }
