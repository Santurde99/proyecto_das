...
switch ($action) {
    case 'new':
        ...
        $query = "INSERT INTO users (username, points, click_points, passive_points, click_multiplier, passive_multiplier)
                 VALUES (?, 0, 1, 0, 1.00, 1.00)";
    ...
    case 'load':
        ...
        $query = "SELECT username, points, click_points, passive_points,
                 click_multiplier, passive_multiplier, last_saved
